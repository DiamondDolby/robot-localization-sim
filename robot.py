...
# --- Display ---
def display(rx, ry, particles, show_particles=False):
    ...
    # Robot (green)
    cv2.circle(lmap, (int(rx), int(ry)), 5, (0, 255, 0), -1)

    # Best guess (mean of particles) (red)
    if len(particles) > 0:
...
def main():
    ...
    while True:
        display(rx, ry, particles, SHOW_PARTICLES)
